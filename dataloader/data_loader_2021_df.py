...
from dataloader.recording_2021_df import DF_Recording2021
...
class DF_DataLoader2021(BaseDataLoader):
    """
        ...
        for file in file_list:
            ...
            if recording_type:
                if self._metadata_list[category][file]['recording_type'] == recording_type:
                    recordings.append(DF_Recording2021(name=file,
...
if __name__ == "__main__":
    ...
    for scenario in scenario_names:
        print(scenario)
        dataloader = DF_Recording2021(base_path + scenario)
